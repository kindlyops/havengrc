...
public class OrganizationResource {
    ...
    public List<OrganizationRepresentation> getCompanies() {
        return session.getProvider(HavenService.class).listCompanies();
    }
    ...
    @Path("{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public OrganizationRepresentation getCompany(@PathParam("id") final String id) {
