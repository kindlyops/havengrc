        ...
        , div [ class "mdc-layout-grid align-center advantages-container" ]
            [ div [ class "mdc-layout-grid__inner" ]
                [ div [ class "mdc-layout-grid__cell--span-12", id "wireframe-container" ]
                    [ img [ alt "Wireframe graphic of compliance and risk dashboard Haven GRC", class "img-lg", attribute "data-rjs" "2", id "wireframe", src "/img/wireframe-large.png" ]
                        []
                    , img [ alt "Wireframe graphic of compliance and risk dashboard Haven GRC", class "img-sm", attribute "data-rjs" "2", id "wireframe", src "/img/wireframe.png" ]
                        []
                    ]
